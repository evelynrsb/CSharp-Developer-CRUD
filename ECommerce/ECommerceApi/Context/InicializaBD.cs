...
namespace ECommerceApi.Context
{
    ...
    {
        public static void Initialize(ECommerceContexto context)
        {
        ...
        private static async void PopularDepartamentos(ECommerceContexto context)
        {
        ...
        private static void PopularProdutos(ECommerceContexto context)
        {
